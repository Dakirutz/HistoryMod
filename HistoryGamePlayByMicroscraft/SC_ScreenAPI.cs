...
{
    ///https://sharpcoderblog.com/blog/unity-3d-capture-screenshot
    /// </summary>
    ...
    {
        string source = "If someone decompile, here is the source of this class: https://sharpcoderblog.com/blog/unity-3d-capture-screenshot";
        ...
        Debug.Log("HISTORYMOD SC_ScreenAPI: 1");
        Texture2D screenshot = new Texture2D(width, height, TextureFormat.RGB24, false);
        Debug.Log("HISTORYMOD SC_ScreenAPI: 2");
        //Read screen contents into the texture
        screenshot.ReadPixels(new Rect(0, 0, width, height), 0, 0);
        screenshot.Apply();

        Debug.Log("HISTORYMOD SC_ScreenAPI: 3");
        if (limitSize > 0)
        {
